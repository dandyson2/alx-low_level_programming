...
/**
* shash_table_create - Function that creates a sortet hash table
* @size: The size of the new sorted hash table.
* Return: Pointer to new sorted list, NULL if error occurs
*/
shash_table_t *shash_table_create(unsigned long int size)
{
shash_table_t *ht;
...
/**
* shash_table_get - Function that prints hash table using
* the sorted linked list
* @ht: Sorted hash table pointer
* @key: The key
*
* Return: The value associated wit the key hash table
* NULL if not matched
*/
char *shash_table_get(const shash_table_t *ht, const char *key)
{
